...
<form name="writeForm" method="post" action="http://localhost:8080/mvcmember/member/write.do">
   <table border="1" cellspacing="0" cellpadding="5">
      ...
      <tr>
         ...
         <td>
            <input type="text" name="id" id="id" placeholder="아이디 입력" onchange="idUnCheck()">
            <input type="button" id="checkIdBtn" value="중복체크" onclick="checkId()">
            <input type="hidden" name="idtf" id="idtf" value="false">
            <div id= "idDiv"></div>
         </td>   
      </tr>
